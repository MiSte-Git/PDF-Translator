"""Ad-hoc live test for GoogleTranslateProvider against the real Google
Cloud Translation API.

Not a pytest test - run manually (requires `pip install -r requirements.txt`
and a key stored via pipeline/credentials.py, see its docstring):

    python tests/manual_test_google_provider.py
"""
